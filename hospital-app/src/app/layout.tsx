...
export const metadata: Metadata = {
  title: 'MediCare - Hospital Management Solution',
  description: 'Efficient, secure, and user-friendly solutions for modern healthcare institutions.',
}
        ...
        <div className="flex flex-col min-h-screen">
          <header className="px-4 lg:px-6 h-14 flex items-center">
            ...
            <Link href="/search" className="text-sm font-medium hover:underline underline-offset-4">
              ...
              <Link href="/stack" className="text-sm font-medium hover:underline underline-offset-4">
